...
class Goods extends BaseController
{
    ...
    public function addGoodsCategory()
    {
        ...
        if (request()->isAjax()) {
            ...
            $is_jieyu = request()->post('is_jieyu','');
			$fenrunprice = request()->post('fenrunprice',0);
            ...
            $result = $goodscate->addOrEditGoodsCategory(0, $category_name, $short_name, $pid, $is_visible,$is_jieyu,$fenrunprice, $keywords, $description, $sort, $category_pic, $attr_id, $attr_name);
    ...
    public function updateGoodsCategory()
    {
        ...
        if (request()->isAjax()) {
            ...
            $result = $goodscate->addOrEditGoodsCategory($category_id, $category_name, $short_name, $pid, $is_visible,$is_jieyu,$fenrunprice, $keywords, $description, $sort, $category_pic, $attr_id, $attr_name);
            return AjaxReturn($result);
        } else {
