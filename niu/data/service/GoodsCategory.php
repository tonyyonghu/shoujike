...
class GoodsCategory extends BaseService implements IGoodsCategory
{
     ...
     */
    public function addOrEditGoodsCategory($category_id, $category_name, $short_name, $pid, $is_visible,$is_jieyu,$fenrunprice, $keywords = '', $description = '', $sort = 0, $category_pic, $attr_id = 0, $attr_name = '')
    {
    ...
    public function getCategoryTreeUseInAdmin(){
        ...
        $goods_category_one = $goods_category_model->getQuery([
            'level' => 1,
        ], 'category_id, category_name,short_name,pid,fenrunprice,category_pic,sort,attr_name,is_visible,is_jieyu', 'sort');
        if(!empty($goods_category_one))
        {
            foreach ($goods_category_one as $k_cat_one => $v_cat_one)
            {
                ...
                if(!empty($goods_category_two_list))
                {
                    ...
                    {
                        $cat_three_list = $goods_category_model->getQuery(['level' => 3,
                            'pid'        => $v_cat_two['category_id']],'category_id,category_name,short_name,pid,fenrunprice,category_pic,sort,attr_name,is_visible,is_jieyu', 'sort');
