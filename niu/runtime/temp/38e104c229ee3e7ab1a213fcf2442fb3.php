<?php if (!defined('THINK_PATH')) exit(); /*a:9:{s:33:"template/adminblue\Ke\tongji.html";i:1568778503;s:28:"template/adminblue\base.html";i:1567740888;s:45:"template/adminblue\controlCommonVariable.html";i:1517036359;s:32:"template/adminblue\urlModel.html";i:1510819828;s:34:"template/adminblue\pageCommon.html";i:1567760212;s:34:"template/adminblue\openDialog.html";i:1516178181;s:41:"template/adminblue\Order\orderAction.html";i:1516870809;s:47:"template/adminblue\Order\orderRefundAction.html";i:1509681407;s:46:"template/adminblue\Order\orderPrintAction.html";i:1512114660;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
	...
	<table class="table-class">
		...
		<tbody>
			<?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
				<tr align="center">
					<td rowspan="3"><?php echo $vo['date']; ?></td>
					<td rowspan="3"><?php echo $vo['categoryname']; ?></td>
					<td rowspan="3"><?php echo $vo['allprice']; ?></td>
					<td><?php echo $vo['mosha']; ?></td>
					<td><?php echo $vo['moshanum']; ?></td>
					<td><?php echo $vo['moshachengben']; ?></td>
					<td rowspan="3"><?php echo $vo['chengben']; ?></td>
					<td rowspan="3"><?php echo $vo['fenrunprice']; ?></td>
					<td rowspan="3"><?php echo $vo['allfenrun']; ?></td>
					<td rowspan="3"><?php echo $vo['jieyu']; ?></td>
					<td rowspan="3"></td>
			</tr>
			<tr align="center">
				<td><?php echo $vo['boli']; ?></td>
				<td><?php echo $vo['bolinum']; ?></td>
				<td><?php echo $vo['bolichengben']; ?></td>
			</tr>
			<tr align="center">
				<td>邮费</td>
				<td colspan="2" style="border-bottom:1px solid #ddd;"><?php echo $vo['youfei']; ?></td>
			</tr>
			<?php endforeach; endif; else: echo "" ;endif; ?>
			<tr align="center">
				<td></td>
				...
				<td></td>
				<td><?php echo $totalchengben; ?></td>
				<td></td>
				<td><?php echo $totalfenrun; ?></td>
				<td><?php echo $totaljieyu; ?></td>
				<td></td>
			</tr>
...
function loadtongjiinfo(){
	...
	$.ajax({
		type : "post",
		url : "<?php echo __URL('ADMIN_MAIN/ke/tongji'); ?>",
		data : {
