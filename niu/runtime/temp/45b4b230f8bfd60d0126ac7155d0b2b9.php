<?php if (!defined('THINK_PATH')) exit(); /*a:9:{s:45:"template/adminblue\Ordernum\ordernumList.html";i:1568615493;s:28:"template/adminblue\base.html";i:1567740888;s:45:"template/adminblue\controlCommonVariable.html";i:1517036359;s:32:"template/adminblue\urlModel.html";i:1510819828;s:34:"template/adminblue\pageCommon.html";i:1567760212;s:34:"template/adminblue\openDialog.html";i:1516178181;s:47:"template/adminblue\Ordernum\ordernumAction.html";i:1567740624;s:50:"template/adminblue\Ordernum\orderRefundAction.html";i:1509681407;s:49:"template/adminblue\Ordernum\orderPrintAction.html";i:1512114660;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
function LoadingInfo(page_index) {
	...
	$.ajax({
		type : "post",
		url : "<?php echo __URL('ADMIN_MAIN/ordernum/ordernumlist'); ?>",
		data : {
	...
	$("#dialog").dialog({
		buttons:{
			"确定":function(){
				$.ajax({
					type:'post',
					url:"<?php echo __URL('ADMIN_MAIN/ordernum/deleteordernum'); ?>",
					data:{'id':id},
					dataType:'json',
					success:function(data){
						console.log(data);
...
$(".ordernuminfo").live('click',function(){
	...
	$.ajax({
		type : "post",
		url : "<?php echo __URL('ADMIN_MAIN/ordernum/ordernuminfo'); ?>",
		data : {
			"ordernum" : ordernum
		},
		success : function(data) {
