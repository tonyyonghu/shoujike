<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:47:"template/adminblue\Goods\goodsCategoryList.html";i:1568950076;s:28:"template/adminblue\base.html";i:1567740888;s:45:"template/adminblue\controlCommonVariable.html";i:1517036359;s:32:"template/adminblue\urlModel.html";i:1510819828;s:34:"template/adminblue\pageCommon.html";i:1567760212;s:34:"template/adminblue\openDialog.html";i:1516178181;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
	...
	<tbody>
		<?php if(is_array($category_list) || $category_list instanceof \think\Collection || $category_list instanceof \think\Paginator): if( count($category_list)==0 ) : echo "" ;else: foreach($category_list as $key=>$v1): ?>
			<tr class="pid_0" style="height: 30px;">
				...
				<td><input class="input-common" type="text" fieldid="<?php echo $v1['category_id']; ?>" fieldname="category_name" value="<?php echo $v1['category_name']; ?>" style="width: 150px;"><a href="javascript:;" onclick="addChildGoodsCategory(<?php echo $v1['category_id']; ?>);">添加子分类</a></td>
				...
				<td style="text-align: center;"><?php echo $v1['fenrunprice']; ?></td>
				<td style="text-align: center;"><?php echo !empty($v1['is_jieyu'])?'是' : '否'; ?></td>
			...
			<tr class="pid_<?php echo $v1['category_id']; ?>" style="height: 30px;display: none;">
				...
				<td><span style="color:#ccc;">|——</span> <input type="text" class="input-common" fieldid="<?php echo $v2['category_id']; ?>" fieldname="category_name" value="<?php echo $v2['category_name']; ?>" style="width: 150px;"><a href="javascript:;" onclick="addChildGoodsCategory(<?php echo $v2['category_id']; ?>);">添加子分类</a></td>
				...
				<td style="text-align: center;"><?php echo $v2['fenrunprice']; ?></td>
				...
				<tr class="pid_<?php echo $v2['category_id']; ?> pid_<?php echo $v1['category_id']; ?>" style="height: 30px;display:none;">
					...
					<td><span style="color:#ccc;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;|——</span> <input class="input-common" type="text" fieldid="<?php echo $v3['category_id']; ?>" fieldname="category_name" value="<?php echo $v3['category_name']; ?>" style="width: 150px;"></td>
					...
					<td style="text-align: center;"><?php echo $v3['fenrunprice']; ?></td>
