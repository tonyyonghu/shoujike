<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:33:"template/adminblue\ke\keedit.html";i:1569306331;s:28:"template/adminblue\base.html";i:1567740888;s:45:"template/adminblue\controlCommonVariable.html";i:1517036359;s:32:"template/adminblue\urlModel.html";i:1510819828;s:34:"template/adminblue\pageCommon.html";i:1567760212;s:34:"template/adminblue\openDialog.html";i:1516178181;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
<div class="set-style">
	<dl>
		...
		<dd>
			<p><input id="ordernum" type="text" value="<?php echo $keinfo['ordernum']; ?>" class="input-common"></p>
	...
	<dl>
		...
		<dd>
			<p><input type="text" id="startDate" value="<?php echo date('Y-m-d H:i:s',$keinfo['ordertime']); ?>" class="input-common" placeholder="请选择开始日期" onclick="WdatePicker({dateFmt: 'yyyy-M-d H:mm:ss'})" /></p>
	...
	<input type="hidden" id="id" value="<?php echo $keinfo['id']; ?>">
	<dl>
		<dt><span class="color-red">*</span>型号:</dt>
		<dd>
			<p><input id="xinghao" type="text" value="<?php echo $keinfo['xinghao']; ?>" class="input-common"></p>
	...
	<dl>
		...
		<dd>
			<p><input id="num" type="text" value="<?php echo $keinfo['num']; ?>" class="input-common"></p>
	...
	<dl>
		...
		<dd>
			<select id="caizhi"  class="select-common w100">
				<option value="1" <?php if($keinfo['caizhi'] == 1): ?> selected<?php endif; ?>>磨砂</option>
				<option value="2" <?php if($keinfo['caizhi'] == 2): ?> selected<?php endif; ?>>玻璃</option>
			</select>
		</dd>
	</dl>
	...
	<dl>
		...
		<dd>
			<p><input id="price" type="text" value="<?php echo $keinfo['price']; ?>" class="input-common"></p>
	...
	<dl>
		...
		<dd>
			<p><input id="chengben" type="text" value="<?php echo $keinfo['chengben']; ?>" class="input-common"></p>
	...
	<dl>
		...
		<dd>
			<p><input type="radio" name="isshunfeng"  value="1" <?php if($keinfo['shunfeng'] == 1): ?> checked="checked"<?php endif; ?> >是&nbsp;&nbsp;&nbsp;<input type="radio" name="isshunfeng"  value="0"  <?php if($keinfo['shunfeng'] == 0): ?> checked="checked"<?php endif; ?>> 否</p>
		</dd>
	</dl>
	...
	<dl>
		...
		<dd>
			<p><input id="youfei" type="text" value="<?php echo $keinfo['youfei']; ?>" class="input-common"></p>
	...
	<dl>
		...
		<dd>
			<p><input id="fenrunprice" type="text"  value="<?php echo $keinfo['fenrunprice']; ?>" class="input-common"></p>
	...
	<dl>
		...
		<dd>
			<p><input id="descs" type="text"  value="<?php echo $keinfo['descs']; ?>" class="input-common"></p>
...
// 		});
	...
	$("#category option").each(function(){
		var val=$(this).val();
		if(val==<?php echo $keinfo['categoryid']; ?>){
