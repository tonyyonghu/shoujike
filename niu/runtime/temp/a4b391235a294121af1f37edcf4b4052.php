<?php if (!defined('THINK_PATH')) exit(); /*a:9:{s:33:"template/adminblue\Ke\keList.html";i:1569828749;s:28:"template/adminblue\base.html";i:1567740888;s:45:"template/adminblue\controlCommonVariable.html";i:1517036359;s:32:"template/adminblue\urlModel.html";i:1510819828;s:34:"template/adminblue\pageCommon.html";i:1567760212;s:34:"template/adminblue\openDialog.html";i:1516178181;s:41:"template/adminblue\Order\orderAction.html";i:1516870809;s:47:"template/adminblue\Order\orderRefundAction.html";i:1509681407;s:46:"template/adminblue\Order\orderPrintAction.html";i:1512114660;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
function LoadingInfo(page_index) {
	...
	$.ajax({
		type : "post",
		url : "<?php echo __URL('ADMIN_MAIN/ke/kelist'); ?>",
		data : {
 	...
 	$("#dialog").dialog({
		buttons:{
			"确定":function(){
				$.ajax({
					type:'post',
					url:"<?php echo __URL('ADMIN_MAIN/ke/deleteke'); ?>",
					data:{'id':id},
					dataType:'json',
					success:function(data){
						console.log(data);
