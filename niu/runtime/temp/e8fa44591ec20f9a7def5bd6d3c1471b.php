<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:32:"template/adminblue\Ke\addKe.html";i:1569995752;s:28:"template/adminblue\base.html";i:1567740888;s:45:"template/adminblue\controlCommonVariable.html";i:1517036359;s:32:"template/adminblue\urlModel.html";i:1510819828;s:34:"template/adminblue\pageCommon.html";i:1567760212;s:34:"template/adminblue\openDialog.html";i:1516178181;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
<div class="set-style">
	<dl>
		...
		<dd>
			<p><input id="ordernum" type="text" value="<?php echo $ordernum; ?>" class="input-common"></p>
	...
	<dl>
		...
		<dd>
			<p><input type="text" id="startDate" class="input-common" value="<?php echo date('Y-m-d H:i:s',$ordertime); ?>" placeholder="请选择添加日期" onclick="WdatePicker({dateFmt: 'yyyy-M-d H:mm:ss'})" /></p>
