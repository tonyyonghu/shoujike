<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:44:"template/adminblue\Ordernum\ordernumAdd.html";i:1568882388;s:28:"template/adminblue\base.html";i:1567740888;s:45:"template/adminblue\controlCommonVariable.html";i:1517036359;s:32:"template/adminblue\urlModel.html";i:1510819828;s:34:"template/adminblue\pageCommon.html";i:1567760212;s:34:"template/adminblue\openDialog.html";i:1516178181;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
<div class="set-style" style="height: 1100px;">
	<dl>
		...
		<dd>
			<p><input id="ordernum" type="text" class="input-common"></p>
	...
	<dl>
		...
		<dd>
			<p><input type="text" id="startDate" class="input-common" placeholder="请选择开始日期" onclick="WdatePicker({dateFmt: 'yyyy-M-d H:mm:ss'})" /></p>
	...
	<dl>
		...
		<dd>
			<p><input id="shouhuouser" type="text" class="input-common"></p>
	...
	<dl>
		...
		<dd>
			<p><input id="mobile" type="text" class="input-common"></p>
	...
	<dl>
		<dt></dt>
		<dd><button class="btn-common btn-big" onclick="addordersAjax();">提交</button></dd>
	</dl>
</div>
